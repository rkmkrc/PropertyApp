...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ListingException.NoPassiveListingsFoundForThisUserException.class)
    public ResponseEntity<?> handleNoPassiveListingsFoundForThisUserException(ListingException.NoPassiveListingsFoundForThisUserException exception, WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(HttpStatus.NOT_FOUND.value(), exception.getMessage(), request.getDescription(false));
        return new ResponseEntity<>(errorDetails, HttpStatus.NOT_FOUND);
    }
